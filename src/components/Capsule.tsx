...
const Capsule: Component<CapsuleProps> = (props) => {
  return (
    <div
      class={`flex items-center justify-center w-fit min-w-11 h-6 gap-1.5 px-2.5 py-0 rounded-lg font-inter ${props.textWeight?? "font-bold"} ${props.textSize ?? "text-xs"} leading-[1.5] tracking-normal
